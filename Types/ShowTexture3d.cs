...
namespace T3.Operators.Types.Id_9733f5e1_4514_46de_9e7c_bd3912932d1b
{
    public class ShowTexture3d : Instance<ShowTexture3d>
    {
        ...
        public readonly Slot<Core.DataTypes.Texture3d> TextureOutput = new Slot<Core.DataTypes.Texture3d>();
        ...
        public readonly InputSlot<Core.DataTypes.Texture3d> Texture = new InputSlot<Core.DataTypes.Texture3d>();
    }
}