...
namespace T3.Operators.Types.Id_d35a403b_7e6e_4725_a344_6e8008a4e1e1
{
    public class PrefixSum : Instance<PrefixSum>
    {
        ...
        public readonly Slot<T3.Core.DataTypes.BufferWithViews> ResultBuffer = new Slot<T3.Core.DataTypes.BufferWithViews>();

        [Input(Guid = "c5561f3b-495e-47e1-95d4-ea3a750f1842")]
        public readonly InputSlot<T3.Core.DataTypes.BufferWithViews> InputList2 = new InputSlot<T3.Core.DataTypes.BufferWithViews>();
